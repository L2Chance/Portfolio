...
import "../navbar/darkModeButton.css";
import React from "react"; // <--- Asegúrate de importar React para sus tipos de evento

function DarkModeButton() {
  const { darkMode, setDarkMode } = useDarkMode();

  //Defino el tipo de dato, para que TypeScript no me regañe
